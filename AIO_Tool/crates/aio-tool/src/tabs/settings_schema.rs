...
/// Embedded copy of `cubictool.json` (lives at the AIO_Tool workspace root,
/// next to `i18n/`). Path is relative to this source file
/// (`crates/aio-tool/src/tabs/settings_schema.rs`) — three parents up reaches
/// the workspace root.
const SCHEMA_RAW: &str = include_str!("../../../../cubictool.json");
