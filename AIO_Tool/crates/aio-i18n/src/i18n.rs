...
// Embedded JSON sources. Paths are relative to this source file (src/i18n.rs is
// at crates/aio-i18n/src/, so three parents up gets to the workspace root where
// i18n/ lives).
const EN_US_RAW: &str = include_str!("../../../i18n/en_US.json");
const ZH_CN_RAW: &str = include_str!("../../../i18n/zh_CN.json");
const ZH_TW_RAW: &str = include_str!("../../../i18n/zh_TW.json");
